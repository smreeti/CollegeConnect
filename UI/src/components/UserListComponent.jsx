...
import { API_TO_FETCH_COMMENT_REPORTS, API_TO_FETCH_ADMIN_USER } from "../../utils/APIRequestUrl.js";
...
const UserListComponent = () => {
    ...
    console.log(loggedInUser.collegeInfoId);


    useEffect(() => {
        fetchAdminUserList(loggedInUser.collegeInfoId);
    }, []);
    ...
    const fetchAdminUserList = async () => {
        setIsLoading(true);
        try {
            const data = await fetchData(API_TO_FETCH_ADMIN_USER, "GET");
            console.log(data);
